...
class  Goods extends Auth
{
		...
		foreach ($listshow as  $value) {
          ...
          return  " 
            <div class=jjg_foods_show_$id>
                <div class='showitems'>
	                <div class='jjg_foods_show_big'><a target='_blank' href='http://www.goodeat.com/index/goods/detailGoods/gid/$idss[0]'>
	                <img src=$shows[0]></a></div>
	                <div class='jjg_foods_show_small '><a target='_blank' href='http://www.goodeat.com/index/goods/detailGoods/gid/$idss[1]'><img src=$shows[1]></a></div>
	                <div class='jjg_foods_show_small '><a target='_blank' href='http://www.goodeat.com/index/goods/detailGoods/gid/$idss[2]'><img src=$shows[2]></a></div>
	                <div class='jjg_foods_show_small '><a target='_blank' href='http://www.goodeat.com/index/goods/detailGoods/gid/$idss[3]'><img src=$shows[3]></a></div>
	                <div class='jjg_foods_show_small '><a target='_blank' href='http://www.goodeat.com/index/goods/detailGoods/gid/$idss[4]'><img src=$shows[4]></a></div>
	                <div class='jjg_foods_show_small '><a target='_blank' href='http://www.goodeat.com/index/goods/detailGoods/gid/$idss[5]'><img src=$shows[5]></a></div>
	                <div class='jjg_foods_show_small '><a target='_blank' href='http://www.goodeat.com/index/goods/detailGoods/gid/$idss[6]'><img src=$shows[6]></a></div>
                </div>
            </div>
		 ";
	...
	public function goodsType()
	{
		...
		if($choice==0){
			//最新商品数据(中间)
			$newList = Goods::where('goodsblock_id',$tid)->paginate(6);
			$newPage = $newList->render();
			$this->assign('newList',$newList);
			$this->assign('newPage',$newPage);
		}elseif($choice==1){
			//按价格降序显示商品
			$newList = Goods::where('goodsblock_id',$tid)->order('price','asc')->paginate(6);
			$newPage = $newList->render();
			$this->assign('newList',$newList);
			$this->assign('newPage',$newPage);
		}else{ 
